...
On considère dès à présent le système (\cref{eq:fold-hopf}) où nous ajoutons un terme stochastique $\xi_i$ avec $i \in {x, y, z}$. Il s'agit en réalité de bruits blancs gaussiens.
